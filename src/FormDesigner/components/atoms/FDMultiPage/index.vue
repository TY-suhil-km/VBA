        ...
        if (this.properties.Style === 0) {
          if (this.properties.TabFixedWidth === 0) {
            if (this.scrolling && this.scrolling.children && this.scrolling.children[0] && this.scrolling.children[0].children[0] && this.scrolling.children[0].children[0].children[1] && this.scrolling.children[0].children[0].children[1].children[0]) {
              ...
              const moveChild = this.scrolling.children.length > 1 && this.properties.Value !== 0 ? this.scrolling.children[0] as HTMLDivElement : this.scrolling.children[1] as HTMLDivElement
              ...
              if (move.offsetHeight > (moveChild.offsetHeight + 4)) {
          ...
          if (controlProp.TabFixedWidth! > 0) {
            if (controlProp.MultiRow) {
              if (controlProp.TabOrientation === 2) {
                width = (controlProp.Width! - this.widthValue - 4) + 'px'
              } else {
                width = (controlProp.Width! - this.widthValue - 6) + 'px'
              }
            } else {
              if (controlProp.TabOrientation === 2) {
                width = controlProp.Width! - controlProp.TabFixedWidth! - 26 + 'px'
              } else {
                width = controlProp.Width! - controlProp.TabFixedWidth! - 28 + 'px'
              }
            }
          } else {
            if (controlProp.TabFixedWidth! === 0) {
              if (controlProp.TabOrientation === 2 || controlProp.TabOrientation === 3) {
                if (controlProp.MultiRow) {
                  if (controlProp.TabOrientation === 2) {
                    width = (controlProp.Width! - this.widthValue - 3) + 'px'
                  } else {
                    width = (controlProp.Width! - this.widthValue - 6) + 'px'
                  }
                } else {
                  if (controlProp.TabOrientation === 2) {
                    width = `${controlProp.Width! - this.tempWidth - 25}px`
                  } else {
                    width = `${controlProp.Width! - this.tempWidth - 28}px`
                  }
                }
              } else {
        ...
        if (controlProp.TabOrientation === 0 || controlProp.TabOrientation === 1) {
          ...
          if (controlProp.TabFixedWidth! > 0) {
            if (controlProp.TabOrientation === 3) {
              ...
              if (controlProp.TabOrientation === 2) {
                width = controlProp.Width! - controlProp.TabFixedWidth! - 12 + 'px'
              } else {
            ...
            if (controlProp.TabFixedWidth! === 0) {
              ...
              controlProp.TabOrientation === 3) {
                if (controlProp.MultiRow) {
                  ...
                  } else if (controlProp.TabOrientation === 3) {
                    width = (controlProp.Width! - this.widthValue - 6) + 'px'
                  }
                } else {
                  if (controlProp.TabOrientation === 2) {
      ...
      if (controlProp.Style === 1) {
            ...
            if (controlProp.TabFixedHeight! > 0) {
              if (this.scrolling) {
                if (controlProp.TabOrientation === 0) {
                  ...
                  height = controlProp.Height! - controlProp.TabFixedHeight! - 31 + 'px'
                }
              } else {
                if (controlProp.TabOrientation === 0) {
        ...
        if (controlProp.TabOrientation === 0 || controlProp.TabOrientation === 1) {
          if (controlProp.MultiRow) {
            if (this.scrolling) {
              if (controlProp.TabOrientation === 0) {
                height = (controlProp.Height! - this.scrolling.clientHeight + 7) + 'px'
              } else {
                if (controlProp.TabFixedHeight! > 0) {
                  height = controlProp.Height! - controlProp.TabFixedHeight! - 16 + 'px'
                } else {
                  height = controlProp.Height! - controlProp.TabFixedHeight! - 28 + 'px'
                }
              }
            } else {
              height = (controlProp.Height! -
          ...
          ? controlProp.Style === 1
            ? controlProp.TabOrientation === 0
              ? controlProp.MultiRow
                ...
                : controlProp.TabFixedHeight! > 0
                  ? controlProp.TabFixedHeight! + 19 + 'px'
                  : controlProp.TabFixedHeight! === 0
            ...
            : controlProp.TabOrientation === 0
              ? controlProp.MultiRow
                ? this.topValue - 5 + 'px'
                : controlProp.TabFixedHeight! > 0
                  ? controlProp.TabFixedHeight! + 7 + 'px'
                  : controlProp.TabFixedHeight! === 0
                    ? this.tempHeight + 16 + 'px'
                    : '33px'
              : controlProp.TabOrientation === 2 || controlProp.TabOrientation === 3 ? '' : '-6px'
          : '0px',
        ...
        controlProp.Style !== 2
          ? controlProp.Style === 1 ? controlProp.TabOrientation === 2
            ? controlProp.MultiRow ? this.widthValue + 'px' : controlProp.TabFixedWidth! > 0
              ? controlProp.TabFixedWidth! + 22 + 'px'
      ...
      if (this.properties.TabOrientation === 2 || this.properties.TabOrientation === 3) {
        ...
        for (let i = 0; i < this.scrolling.children.length; i++) {
          if (this.properties.Style === 1) {
            ...
            sum += ((this.properties.Value === 0 ? this.scrolling.children[1].children[0].clientHeight : this.scrolling.children[0].children[0].clientHeight) + 7)
        ...
        if (totalHeight < sum) {
          if (this.properties.Style === 1) {
            count = totalHeight / ((this.properties.Value === 0 ? this.scrolling.children[1].children[0].clientHeight : this.scrolling.children[0].children[0].clientHeight) + 7)
          } else if (this.properties.Style === 0) {
        ...
        if (controlProp.TabFixedHeight === 0) {
          if (((pagecount) % Math.trunc(count)) !== 0) {
            ...
            for (let index = pagecount - ((pagecount) % Math.trunc(count)), j = 0; index < pagecount; index++, j++) {
              ...
              mydivref.style.height = this.properties.Style === 0 ? `${labelHeight + 14}px` : `${labelHeight + 26}px`
              myref.style.height = `${labelHeight - 5}px`
            }
